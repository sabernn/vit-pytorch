...
if __name__ == "__main__":
    ...
    trainset_lmd = data.toTorchDataset(is_train=True)
    trainloader_lmd = torch.utils.data.DataLoader(trainset_lmd, batch_size=batch_size,
    ...
    for epoch in range(n_epoch):  # loop over the dataset multiple times
        ...
        for i, data in enumerate(trainloader_lmd, 0):
